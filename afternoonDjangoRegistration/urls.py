...
urlpatterns = [
    ...
    path('add_product/',general_views.add_product, name='my-add_product'),
    ...
    path('update-products/<id>', general_views.update_products, name='update-product'),
    path('add-supplier', general_views.add_supplier, name='add-supplier'),
    path('suppliers/', general_views.view_supplier, name='suppliers'),
    path('delete-suppliers/<id>', general_views.delete_supplier, name='delete-suppliers'),
